 ...
 * @LastEditors: shen
 * @LastEditTime: 2022-06-05 10:24:29
 * @Description: 
-->
...
<template>
  <CountCard meta="运营活动效果" footerMeta="活动效果" :total="65" :footerTotal="20" :contentStyle="{ height: '100%' }" suffix="%" tip="运营活动效果" :loading="loading">
